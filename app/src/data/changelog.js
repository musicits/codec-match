...
export const CHANGELOG = [
  {
    version: 'v15',
    summary: '두 화면이 같은 머리말·지표를 쓴다 · 코덱 카드 자리 고정',
    date: '2026-09-18',
    phones: 135,
    audio: 104,
    changes: [
      '스트리밍 음질 화면도 코덱 화면과 같은 머리말과 지표를 씁니다 — 화면을 바꿔도 코덱 카드가 같은 자리에 섭니다',
      '스트리밍 화면 지표를 최대 비트레이트 · 대략적 지연시간 · 음질 상한 세 칸으로',
      '머리말·지표·코덱 카드 폭을 680px 로 묶어 두 화면의 글줄이 어긋나지 않습니다 (표는 그대로 넓게)',
    ],
  },
  {
    version: 'v14',
    ...
    changes: [
      ...
      '삼성 심리스 등급표가 붙는 조합에서도 카드가 아래로 밀리지 않습니다 (870px → 592px)',
      ...
      '스트리밍 음질 화면은 파형 바로 아래에 지금 코덱으로 제값 하는 서비스를 작게 답니다',
      '두 화면의 기기 한 쌍이 같은 자리에 서도록 폭을 맞췄습니다 — 화면을 바꿔도 아이콘이 움직이지 않습니다',
      '그 이름을 누르면 아래 표의 해당 서비스 줄로 내려가 잠깐 불이 들어옵니다 (해외 서비스면 국내·해외 거르기도 따라 바뀝니다)',
